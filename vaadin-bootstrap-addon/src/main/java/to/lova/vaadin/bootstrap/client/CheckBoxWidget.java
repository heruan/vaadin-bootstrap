...
public class CheckBoxWidget extends ButtonBase
    ...
    private final InputElement inputElement = DOM.createInputCheck().cast();
    ...
    public CheckBoxWidget() {
        ...
        this.getElement().addClassName("custom-checkbox");
